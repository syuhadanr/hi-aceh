...
/>
  ...
  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
   ...
   <a href={`https://www.tiktok.com/share?text=${encodeURIComponent(article.title)}&url=${encodeURIComponent(articleUrl)}`} target="_blank" rel="noopener noreferrer" className="bg-black text-white w-9 h-9 rounded flex items-center justify-center hover:opacity-90" aria-label="Share to TikTok"> <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
