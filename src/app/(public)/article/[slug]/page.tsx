          ...
          <main className="lg:w-[68%]">
              ...
              if (paragraphs.length <= 2) {
                return (
                  <div className="prose prose-lg max-w-none text-gray-800 dark:text-zinc-300 dark:prose-invert font-sans leading-loose mb-12">
                    <div
                      className="first-letter:text-5xl first-letter:font-bold first-letter:text-brand-green dark:first-letter:text-brand-green first-letter:mr-3 first-letter:float-left first-letter:font-display"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-gray-50 dark:bg-zinc-900 p-4 border-l-4 border-brand-green mb-12 font-sans gap-4">
              ...
              <div className="flex gap-2 shrink-0">
                <a href={`https://www.facebook.com/sharer/sharer.php?u=`} target="_blank" rel="noopener noreferrer" className="bg-[#3b5998] text-white w-9 h-9 rounded flex items-center justify-center hover:opacity-90">
                  <i className="material-icons text-sm">facebook</i>
                </a>
                <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(article.title)}`} target="_blank" rel="noopener noreferrer" className="bg-black text-white w-9 h-9 rounded flex items-center justify-center hover:opacity-90">
                  <i className="material-icons text-sm">flutter_dash</i>
                </a>
                <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(article.title + ' ')}`} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white w-9 h-9 rounded flex items-center justify-center hover:opacity-90">
                ...
                <a href={`mailto:?subject=${encodeURIComponent(article.title)}`} className="bg-gray-700 text-white w-9 h-9 rounded flex items-center justify-center hover:opacity-90">
