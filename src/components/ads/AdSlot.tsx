...
const maxHeightMap: Record<string, string> = {
  HEADER_BETWEEN: "max-h-[200px]",
  MAIN_BELOW_HEADLINE: "max-h-[192px]",
  POPULAR_BELOW: "max-h-[192px]",
  FEATURED_AFTER_SELESAI: "max-h-[200px]",
  FEED_AFTER_SELESAI: "max-h-[200px]",
  FEED_ASIDE_TOP: "max-h-none",
  FEED_ASIDE_MID: "max-h-none",
  FEED_ASIDE_BOTTOM: "max-h-none",
  FEED_INLINE_1: "max-h-[160px]",
  FEED_INLINE_2: "max-h-[300px]",
  ARTICLE_ABOVE_TITLE: "max-h-[200px]",
  ARTICLE_BELOW_IMAGE: "max-h-[450px]",
  ARTICLE_IN_CONTENT: "max-h-[450px]",
  ARTICLE_END: "max-h-[450px]",
  SIDEBAR: "max-h-[400px]",
  MOBILE_HEADER: "max-h-[200px]",
  MOBILE_FEED_1: "max-h-[300px]",
  MOBILE_FEED_2: "max-h-[300px]",
  MOBILE_FEED_AFTER: "max-h-[300px]",
  MOBILE_ARTICLE_ABOVE: "max-h-[200px]",
  MOBILE_ARTICLE_MIDDLE: "max-h-[300px]",
  MOBILE_ARTICLE_END: "max-h-[300px]",
};
