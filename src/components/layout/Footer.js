        ...
        <footer className="bg-zinc-950 text-white border-t-4 border-brand-green font-sans">
            ...
            <div className="md:hidden px-5 pt-6 pb-0 flex flex-col items-center">
                ...
                <div className="flex gap-2 mb-5">
                    ...
                    <a href={settings?.socialTikTok || "#"} target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                        className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-black transition-colors p-1 overflow-visible">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
                        ...
                        <div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <a href={settings?.socialTikTok || "#"} target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                                    className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center hover:bg-black transition-colors p-1 overflow-visible">
